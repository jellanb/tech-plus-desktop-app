...
// Init Open New Windows Buttons
document.getElementById('button-product-without-register').addEventListener('click', () => {
    window.action.openWindow('product-without-register/index.html', 800, 600);
});

document.getElementById('button-pay').addEventListener('click', () => {
    window.action.openWindow('pay/index.html', 900, 700);
});

document.getElementById('button-new-client').addEventListener('click', () => {
    window.action.openWindow('client/index.html', 900, 600);
});

document.getElementById('button-credit-report').addEventListener('click', () => {
    window.action.openWindow('credit-report/index.html', 1000, 850);
});
// End Open New Windows Buttons
...
document.getElementById('nav-item-shell').addEventListener('click', () => {
    changeContent('content-shell-module', 'nav-item-shell');
});

document.getElementById('nav-item-client').addEventListener('click', () => {
    changeContent('content-client-module', 'nav-item-client');
});

document.getElementById('nav-item-products').addEventListener('click', () => {
    changeContent('content-products-module', 'nav-item-products');
});

document.getElementById('nav-item-category').addEventListener('click', () => {
    changeContent('content-category-module', 'nav-item-category');
});

document.getElementById('nav-item-inventory').addEventListener('click', () => {
...
document.getElementById('nav-item-cutoff').addEventListener('click', () => {
